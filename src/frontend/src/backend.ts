...
export class Backend implements backendInterface {
    ...
    async addReading(arg0: number): Promise<Reading> {
        if (this.processError) {
            try {
                const result = await this.actor.addReading(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllReadings(): Promise<Array<Reading>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllReadings();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLatestReading(): Promise<Reading> {
        if (this.processError) {
            try {
    ...
    async sayHello(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.sayHello(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
